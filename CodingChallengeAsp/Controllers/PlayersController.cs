...
namespace CodingChallengeAsp.Controllers
{
    public class PlayersController : Controller
    {
        ...
        {
            var footballContext = _context.Player.Include(p => p.Team);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerId,FirstName,LastName,ShirtNumber,TeamId")] Player player)
        {
